...
if (isset($_GET['userId'])) {
    ...
    $userPatents = $db->query('SELECT * FROM patents')->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <!-- Title Page-->
    <title>Tüm Patent Başvuruları</title>
            ...
            $(".item").on('click', function(e) {
                ...
                tbody.onclick = function(e) {
                    ...
                    if (buttonValue == "Görüntüle") {
                        ...
                        window.location.href = "tto-show-patent.php?userId=<?php echo $_GET['userId'] ?>&patentCode=" + data[0]

                    } else if (buttonValue == "Girişimciye Gönder") {

                        $.post("tto-patent-send-to-entrepreneur.php", {
                            data: data[0]
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Tüm Patent Başvuruları</h3>
                                    ...
                                    <table class="table table-data2" id="data-table">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($userPatents as $apply) : ?>
                                                ...
                                                <td id="tdvalue"><?php echo $apply['patentCode'] ?></td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    $projectTransection  = $db->query("SELECT * FROM patentstatus WHERE Patents_idPatents=" . $apply['idPatent'])->fetch(PDO::FETCH_ASSOC);
