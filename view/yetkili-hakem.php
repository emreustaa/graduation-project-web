                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="yetkili-hakem.php?userId=<?php echo $_GET['userId'] ?>">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="yetkili-hakem-table.php?userId=<?php echo $_GET['userId'] ?>">
