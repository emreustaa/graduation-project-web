...
if (isset($_GET['userId'])) {
    ...
    $before = date("Y-m-d H:i:s", strtotime(date("Y-m-d H:i:s", strtotime(date("Y-m-d"))) . "-1 month"));
    $userApplies = $db->query("SELECT * FROM applies INNER JOIN statutransections ON applies.idApply = statutransections.Applies_idApply ORDER BY date DESC LIMIT 5")->fetchAll(PDO::FETCH_ASSOC);
}
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="tto-coming-process.php?userId=<?php echo $_GET['userId'] ?>">
                                <i class="fas fa-comments"></i>Gelen Kutusu
                                <span class="arrow">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Gelen Kutusu</h3>
                                            ...
                                            <?php foreach ($userApplies as $apply) : ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="table-data-feature">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" id="show-button" name="show-button" data-placement="top" title="Görüntüle" value="Görüntüle">
