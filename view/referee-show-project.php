...
if (isset($_GET['userId']) && isset($_GET['projectCode'])) {
    ...
    $projectReports = $db->query("SELECT fileName,location,size from files WHERE Apply_idApply = " . $userApplies['idApply'])->fetchAll(PDO::FETCH_ASSOC);
    ...
    if (isset($_POST['submit'])) {
        echo '<script>window.location.href = "yetkili-hakem-table.php?userId=' . $userId . '";</script>';
        exit;
    }
}
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <form action="" id="data-form" method="post" enctype="multipart/form-data" class="form-horizontal" accept-charset="UTF-8">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="start-date-input" name="start-date-input" placeholder="Tarihi Yazınız" disabled=TRUE value="<?php echo $transitionApply['startDate'] ?>" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="start-date-input" name="start-date-input" placeholder="Tarihi Yazınız" disabled=TRUE value="<?php echo $transitionApply['deadline'] ?>" class="form-control">
