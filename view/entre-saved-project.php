...
if (isset($_GET['userId'])) {
    ...
    $userApplies = $db->query('SELECT * FROM applies INNER JOIN statutransections ON  statutransections.Applies_idApply = applies.idApply WHERE statutransections.Status_idStatus="8"&&Users_idUser=' . $_GET['userId'])->fetchAll(PDO::FETCH_ASSOC);
}
...
<head>
    ...
    <!-- Title Page-->
    <title>Taslak Olarak Kaydedildi</title>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Taslak Olarak Kayıtlı Projeler</h3>
                                    ...
                                    <table class="table table-data2" id="data-table">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <?php foreach ($userApplies as $apply) : ?>
                                                ...
                                                <td>
                                                    <span class="status--saved">Taslak Olarak Kaydedildi</span>
                                                </td>
                                                <td>
                                                    <?php
