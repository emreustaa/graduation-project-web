...
if (isset($_GET['userId'])) {
    ...
    $userApplies = $db->query('SELECT * FROM applies INNER JOIN statutransections ON  statutransections.Applies_idApply = applies.idApply WHERE statutransections.Status_idStatus="3"&&' . $_GET['userId'] . '')->fetchAll(PDO::FETCH_ASSOC);
}
...
<head>
    ...
    <!-- Title Page-->
    <title>Düzenleme Bekleyen Projeler</title>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Düzenleme Bekleyen Projeler</h3>
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <?php foreach ($userApplies as $apply) : ?>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="status--waiting">Düzenleme Talebi</span>
                                                    <!-- 
                                                          <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="table-data-feature">
                                                        ...
                                                        <button style="visibility: <?php echo $disabled['editStatu'] == "TRUE"  ? "visible" : "hidden" ?>; display: <?php echo $disabled['editStatu'] == "TRUE"  ? "visible" : "none" ?>;" class="item" data-toggle="tooltip" data-placement="top" id="edit-button" name="edit-button" title="Düzenle ve Gönder" value="Düzenle ve Gönder">
