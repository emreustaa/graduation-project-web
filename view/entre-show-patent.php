...
if (isset($_GET['userId']) && isset($_GET['patentCode'])) {
    ...
    $projectReports = $db->query("SELECT fileName,location,size from patentfiles WHERE Patents_idPatents = " . $userApplies['idPatent'] . " && User_idUser=" . $loginUsers['idUser'])->fetchAll(PDO::FETCH_ASSOC);
    ...
    if (isset($_POST['submit'])) {
        echo '<script>window.location.href = "entre-all-patents.php?userId=' . $userId . '";</script>';
        exit;
    }
}
