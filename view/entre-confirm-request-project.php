...
if (isset($_GET['userId'])) {
    ...
    $userApplies = $db->query('SELECT * FROM applies INNER JOIN statutransections ON  statutransections.Applies_idApply = applies.idApply WHERE statutransections.Status_idStatus="4"&&Users_idUser=' . $_GET['userId'])->fetchAll(PDO::FETCH_ASSOC);
}
...
<head>
    ...
    <!-- Title Page-->
    <title>Onay Bekleyen Projeler</title>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Onay Bekleyen Projeler</h3>
                                    ...
                                    <table class="table table-data2" id="data-table">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <?php foreach ($userApplies as $apply) : ?>
                                                ...
                                                <td>
                                                    <span class="status--looking">Onay Bekleniyor</span>
                                                </td>
                                                <td>
                                                    <?php
